...
class SpotsListViewController: UIViewController {
    ...
    func sortBasedOnSegmentPressed() {
        ...
        case 2: //avg rating
            print("need avg rating")
        default:
            print("ERROR: Hey you should have gotten here, our segmented control should just have three segments")
        }
...
extension SpotsListViewController: CLLocationManagerDelegate{
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .restricted:
            showAlert(title: "Location services denied", message: "It may be that parental controls are restricting use in this app")
